...
[CreateAssetMenu(menuName = "Quest/Make Quest", fileName = "Quest_")]
public class Quest : SerializedScriptableObject
{
    ...
    [SerializeField] private Condition[] canceleConditions;
    ...
    public virtual bool IsCancelable => isCancelable && canceleConditions.All(x => x.IsPass(this));
    ...
    [Conditional("UNITY_EDITOR")] //debug function
