...
public class Task : SerializedScriptableObject
{
    #region Events
    public delegate void StateChangedHandler(Task task, TaskState currentState, TaskState prevState);
    public delegate void SuccessChangedHander(Task task, int currentSuccess, int prevSuccess);
    #endregion
    ...
    [Header("Setting")]
    [SerializeField] private InititalSuccessValue initialSuccessValue;
    ...
    public event SuccessChangedHander onSuccessChanged;
